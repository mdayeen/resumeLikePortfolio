...
export const metadata: Metadata = {
  title: "About Mohammed Ayeenuddin | Full Stack MERN Developer",
  description: "Professional profile of Mohammed Ayeenuddin, Full Stack MERN Developer, SaaS Architect, and Co-Founder of Anjeer Labs based in Hyderabad, India.",
  alternates: {
    canonical: "./",
  }
}
...
export default function About() {
  const experiences = [
    {
      ...
      details: [
        "Co-founded Anjeer Labs, a fast-growing software development agency specialized in building custom web, mobile SaaS platforms, and enterprise solutions.",
  ...
  const certifications = [
    "Full Stack MERN Developer Certification - Code For India Org",
      ...
      <main className="container py-12 max-w-4xl space-y-12">
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-4">
            <div className="md:col-span-2 space-y-4 text-muted-foreground leading-relaxed text-base sm:text-lg">
              <p>
                Hi, I'm <strong>Mohammed Ayeenuddin</strong>. I'm a Full Stack MERN Developer, SaaS Architect, and the Co-Founder of <strong>Anjeer Labs</strong> based in Hyderabad, India.
              </p>
              <p>
        ...
        <section className="space-y-6">
          <h2 className="text-3xl font-bold flex items-center gap-2">
            <Briefcase className="h-6 w-6 text-violet-500" /> Career Journey
          </h2>
          <div className="space-y-8 pl-4 border-l border-violet-100 dark:border-violet-900 ml-2">
            {experiences.map((exp, idx) => (
              <div key={idx} className="relative space-y-2">
                <div className="absolute -left-[25px] top-1.5 w-3.5 h-3.5 rounded-full border-2 border-violet-500 bg-background" />
        ...
        <section className="space-y-6">
          <h2 className="text-3xl font-bold flex items-center gap-2">
            <GraduationCap className="h-6 w-6 text-violet-500" /> Academic Background
          </h2>
        ...
        <section className="space-y-6">
          <h2 className="text-3xl font-bold flex items-center gap-2">
            <Award className="h-6 w-6 text-violet-500" /> Certifications & Credentials
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {certifications.map((cert, idx) => (
              <div key={idx} className="flex gap-3 items-center border rounded-lg p-4 bg-card">
                <Award className="h-5 w-5 text-violet-600 shrink-0" />
        ...
        <section className="border rounded-2xl p-6 sm:p-8 bg-muted/40 text-center space-y-4">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            I am currently open to consulting engagements, full-time engineering roles, and custom agency development work through Anjeer Labs. Let's discuss your next project.
          </p>
